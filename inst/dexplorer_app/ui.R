fluidPage(
  ...
  tags$script(src = "hide_show_main_tabs.js"),
  tags$script(src = "data_table.js"),
  tags$script(src = "custom_tooltip.js"),
  tags$script(src = "customModal.js"),
  tags$script(src = "colorPaletteChoicesIconsChoice.js"),
  tags$script(src = "colorPaletteChoicesIconsSelected.js"),
  tags$script(src = "palette_renderer.js"),
  includeHTML("www/customModal.html"),
  ...
  navbarPage(
    ...
    tabPanel(
      "Home",
      div(
        img(src = "logo.png", style = "margin-top: 200px;"),
